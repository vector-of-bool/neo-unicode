...
extern "C" {
	#include "../../../source/internal/codepoint.h"
}
...
static inline void generateCodepoint(size_t, unicode_t& out)
{
	out = generateInRange<unicode_t>(0x0000, MAX_LEGAL_UNICODE);
}

static inline void generateCodepoint(size_t, utf16_t& out)
{
	out = generateInRange<utf16_t>(0x0000, MAX_BASIC_MULTILINGUAL_PLANE);
}

static inline void generate(size_t n, std::string& out)
{
	uint8_t first_byte;
	...
	{
		out.push_back((char)generateInRange<uint8_t>(0x80, 0xBF));
	}
}
